...
<html lang="en">
  ...
  async passwordResetMail(Email, link) {
    try {
      ...
      await this.client.send({
        ...
        subject: `Tuitionflex Reset password`,
        text: body,
  ...
  async sendOtp(email, otp) {
    try {
      ...
      await this.client.send({
        to: email,
        from: process.env.FromMail,
        subject: `Tuitionflex Login Auth`,
        text: body,
        attachments: this.data,
        html:
          this.html1 +
  ...
  async cosignerWelcome(
    ...
    <p>${firstName}  ${lastName} has requested you to co-sign ${firstName}'s tuition credit
    ...
    so, you will need to register with your email id  ${email} before you can login and complete your portion of the application.</p>
    
    <p>If you have already registered Kindly login.</p>
...
<span>customerservice@tuitionflex.com</span><br>
    ...
    <p>${firstName}  ${lastName} has requested you to co-sign ${firstName}'s tuition credit
    plan to attend ${schoolName}. We require you to provide additional information in order to complete the application.
    To do so, please click on the link below and you will be directed to our online web portal.Kindly create account with ${email} If you have not already done
...
<span><a href="https://www.customerservice@tuitionflex.com">customerservice@tuitionflex.com</a></span><br>
  ...
  async cosignerEsign(
    ...
    try {
      ...
      <h2>Tuitionflex</h2>
      <p>Dear ${CosignerfirstName},</p>
        <p>Thank you for completing your portion of ${firstName}'s application  for the ${schoolName} tuition credit plan.  
            In order to completed the process, you will need to electronically sign the TuitionFlex agreement.  Please 
            click on the link below and you will be directed to the online portal.  If you have not already done so, you will need ot register before you can login and sign the agreement. </p>


<a href="${link}">Click here: ${content}</a>
...
<span>customerservice@tuitionflex.com</span><br>
      ...
      await this.client.send({
        to: email,
        from: process.env.FromMail,
        subject: `Tuitionflex/${schoolName} `,
        text: body,
        attachments: this.data,
        html:
          this.html1 +
...
<span>customerservice@tuitionflex.com</span><br>    
  ...
  async borrowerreviewdisclosure(
    email,
    firstName,
    schoolName,
    link,
    ...
    <p>Thank you for electronically signing your TuitionFlex tuition credit plan agreement with ${schoolName}. Your Final disclosure is ready for review. IT IS IMPORTANT
    THAT YOU REVIEW YOUR DISCLOSURE IMMEDIATELY. If for any reason you would like to cancel your tuition credit plan, you have until midnight on ${expireDate} to do so, the terms of which are outlined in 
    your disclosure.</p>

   
    <p>Your TuitionFlex account will be serviced by Launch Servicing and you will be sent a Welcome Letter
    from them a few weeks prior to your first payment due date.If you have ay questions, please contact ed2go office
    or TuitionFlex Customer Service at 866-758-7123</p>
   
   <p>To view your agreement and Final Disclosure, click on the link below and login to your TuitionFlex Account  </p>
...
<span><a href ="">customerservice@tuitionflex.com </a></span>
      ...
      await this.client.send({
        to: email,
        from: process.env.FromMail,
        subject: `${process.env.title1} Review Final Disclosure and Signup for Recurring 
        Payments (optional)
        `,
        text: body,
        attachments: this.data,
...
<span><a href ="https://customerservice@tuitionflex.com">customerservice@tuitionflex.com </a></span>
  ...
  async cosignerreviewdisclosure(
    email,
    firstName,
    lastname,
    expireDate,
    ...
    <p>Thank you for electronically signing your TuitionFlex tuition credit plan agreement . Your Final disclosure is ready for review. IT IS IMPORTANT
    THAT YOU REVIEW YOUR DISCLOSURE IMMEDIATELY. If for any reason you would like to cancel your tuition credit plan, you have until midnight on ${expireDate} to do so, the terms of which are outlined in 
    your disclosure.</p>
...
<span><a href ="">customerservice@tuitionflex.com </a></span>
      ...
      await this.client.send({
        to: email,
        from: process.env.FromMail,
        subject: `${process.env.title1} Review Final Disclosure `,
        text: body,
        attachments: this.data,
        html:
          this.html1 +
