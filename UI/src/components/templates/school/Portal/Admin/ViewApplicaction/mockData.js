export const httpResponse = {
  ...
  interestRate: "12%",
  inSchoolPaymentAmount: "$4,170.34",
  outOfSchoolPaymentAmount: "$4,170.34",
};
...
export const groupTableData = (data) => {
  return {
    ...
    applicationInfo: {
      ...
      inSchoolPaymentAmount: data?.inSchoolPaymentAmount || "",
      outOfSchoolPaymentAmount: data?.outOfSchoolPaymentAmount || "",
    },
  };
};
