...
import Form from "../../../components/templates/school/Portal/Search/Form";
import Table from "../../../components/templates/school/Portal/Search/Table";
...
const Search = () => {
  ...
  return (
    <Layout currentRoute={routes.SEARCH}>
      <Wrapper>
